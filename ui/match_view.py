...
class MatchView(tk.Frame):
    ...
    def _create_admin_controls(self, parent):
        ...
        controls_frame.pack(fill='both', expand=True, pady=(SPACING, 0))

        canvas = tk.Canvas(controls_frame, bg=COLORS['card_bg'], highlightthickness=0)
        ...
        # 👇 IMPORTANT: use scroll_frame instead of controls_frame below
        controls_frame = scroll_frame
